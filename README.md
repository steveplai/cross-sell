...
Cross-sell emails support two asset domain modes:
...
Manual full-email diagnostics can use copied HTML files under
`manual-emails/`. These files are not generated by `pnpm build:emails`.
