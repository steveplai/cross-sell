...
// Runtime fallback/base data used when a consumer has not supplied full widget data.
export const flightOrderCrossSellFallbackData: FlightOrderCrossSellData = {
  locale: 'zh-TW',
  currency: 'TWD',
  domainMode: 'uat',
  order: {
...
export const flightOrderCrossSellConnectedBaseData: FlightOrderCrossSellData =
