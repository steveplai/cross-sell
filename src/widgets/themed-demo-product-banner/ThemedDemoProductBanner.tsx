...
const themedDemoProductBannerRootProps = createWidgetRootProps(
  'themed-demo-product-banner',
)

export type ThemedDemoProductBannerLayout = 'compact' | 'grid' | 'carousel'

export interface ThemedDemoProductBannerProps {
  title: string
  locale?: string
  layout?: ThemedDemoProductBannerLayout
  products: Product[]
  loading?: boolean
  onSelectProduct?: (product: Product) => void
}

export function ThemedDemoProductBanner({
  title,
  locale = 'zh-TW',
  layout = 'grid',
  products,
  ...
  if (loading) {
    return (
      <section
        ...
        {...themedDemoProductBannerRootProps}
      >
