...
interface ReminderIconGlyphProps extends SVGProps<SVGSVGElement> {
  icon: CrossSellWidgetReminder['icon']
}
...
function ReminderIcon({ icon }: { icon: CrossSellWidgetReminder['icon'] }) {
  return (
    <span
      className={cn(
...
function ReminderCardContent({ item }: { item: CrossSellWidgetReminder }) {
  return (
    <>
